...
class KeywordMonitor:
    ...
    def __init__(
        self,
        data_file: str = "political_keywords.json",  # JSON file to store keyword data
        rss_url: str = "https://news.google.com/rss/search?q=politics",  # URL of the RSS feed to monitor
        max_age_days: int = 30,  # Max age, in days, for a keyword before pruned
        min_mentions: int = 1,  # Min number of mentions for a keyword to be retained
        # TODO: use multiple RSS feeds so that a value > 1 for min_mentions is feasible
    ):
    ...
    def _save_keyword_data(self, data=None) -> None:
    ...
    def update_keyword_database(self, entities: Dict[str, str]) -> None:
    ...
    def prune_stale_keywords(self) -> None:
